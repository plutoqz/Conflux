...
以下项目由 [研究查询重设计.md](../研究查询重设计.md) 的 H-K 阶段统一定义和跟踪，本摘要不重复维护状态：

| 阶段 | 内容 | 跟踪位置 |
|------|------|---------|
| H | V2真实API A/B对比评测 | [研究查询重设计.md](../研究查询重设计.md) §H |
| I | 根据盲评结果调整prompt/参数 | [研究查询重设计.md](../研究查询重设计.md) §I |
| J | 硬编码清理 | [研究查询重设计.md](../研究查询重设计.md) §J |
| K | 清理到期废弃代码 | [研究查询重设计.md](../研究查询重设计.md) §K |
